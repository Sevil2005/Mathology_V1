...
def olympiads():
    return render_template('olympiads.html', title="Riyaziyyat Olimpiadaları")


@app.route('/tövsiyə-edilən-materiallar')
def materials():
    return render_template('materials.html', title="Tövsiyə Edilən Materiallar")
...
def new_post():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('home'))
    return render_template('create_post.html', title="Yeni Məqalə", form=form, legend = 'Yeni Məqalə')
...
def update_post(post_id):
    ...
    return render_template('create_post.html', title="Məqaləni Yenilə", form=form, legend = 'Məqaləni Yenilə')
